...
struct efi_fw_image fw_images[] = {
	{
		.image_type_id = AM62PX_VAR_SOM_TIBOOT3_IMAGE_GUID,
		.fw_name = u"AM62PX_VAR_SOM_TIBOOT3",
		.image_index = 1,
	},
	{
		.image_type_id = AM62PX_VAR_SOM_SPL_IMAGE_GUID,
		.fw_name = u"AM62PX_VAR_SOM_SPL",
		.image_index = 2,
	},
	{
		.image_type_id = AM62PX_VAR_SOM_UBOOT_IMAGE_GUID,
		.fw_name = u"AM62PX_VAR_SOM_UBOOT",
		.image_index = 3,
	}
};
