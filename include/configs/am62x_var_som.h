 ...
 * define AM62X_VAR_SOM_SPL_IMAGE_GUID     - firmware GUID for VAR-SOM-AM62 SPL
 * define AM62X_VAR_SOM_UBOOT_IMAGE_GUID   - firmware GUID for VAR-SOM-AM62 UBOOT
 *
